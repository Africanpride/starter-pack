                        ...
                        <div class="card-body">
                           <div class="d-flex align-items-center justify-content-between">
                              ...
                              <div class="congratulation-img">
                                 <img src = " {{ asset('backend/assets/img/media/congratulation-img.png') }}" alt="">
                              </div>
                           </div>
                        </div>
                     </div>
                           ...
                           <div class="card mb-30 progress_1">
                              <div class="card-body">
                                 ...
                                 <div class="d-flex flex-wrap mb-2 progress-info">
                                    <div>Users</div>
                                    <div><img src = " {{ asset('backend/assets/img/svg/caret-up.svg ') }}" alt="" class="svg"> 2.6k</div>
                                    <div><img src = " {{ asset('backend/assets/img/svg/caret-down.svg ') }}" alt="" class="svg">568</div>
                                 </div>


                                 <div class="d-flex flex-wrap progress-info">
                                    <div>Disabled</div>
                                    <div><img src = " {{ asset('backend/assets/img/svg/caret-up.svg ') }}" alt="" class="svg">1.26k</div>
                                    <div><img src = " {{ asset('backend/assets/img/svg/caret-down.svg ') }}" alt="" class="svg">25</div>
                                 </div>
                              </div>
                           </div>
                           <!-- End Card -->
                        ...
                        <div class="col-md-4 col-sm-6">
                           ...
                           <div class="card mb-30 progress_2">
                              <div class="card-body">
                                 ...
                                 <div class="d-flex flex-wrap mb-2 progress-info">
                                    <div>Net Profit</div>
                                    <div><img src = " {{ asset('backend/assets/img/svg/caret-up.svg ') }}" alt="" class="svg"> 268k</div>
                                    <div><img src = " {{ asset('backend/assets/img/svg/caret-down.svg ') }}" alt="" class="svg">89k</div>
                                 </div>
                                 ...
                                 <div class="d-flex flex-wrap progress-info">
                                    <div>Expenses</div>
                                    <div><img src = " {{ asset('backend/assets/img/svg/caret-up.svg ') }}" alt="" class="svg">1.26k</div>
                                    <div><img src = " {{ asset('backend/assets/img/svg/caret-down.svg ') }}" alt="" class="svg">1.5k</div>
                                 </div>
                              </div>
                           </div>
                           <!-- End Card -->
                        ...
                        <div class="col-md-4 col-sm-6">
                           ...
                           <div class="card mb-30 progress_3 mr-0">
                              <div class="card-body">
                                 ...
                                 <div class="d-flex flex-wrap mb-2 progress-info">
                                    <div>Employee</div>
                                    <div><img src = " {{ asset('backend/assets/img/svg/caret-up.svg ') }}" alt="" class="svg">15</div>
                                    <div><img src = " {{ asset('backend/assets/img/svg/caret-down.svg ') }}" alt="" class="svg">3</div>
                                 </div>
                                 ...
                                 <div class="d-flex flex-wrap progress-info">
                                    <div>Production</div>
                                    <div><img src = " {{ asset('backend/assets/img/svg/caret-up.svg ') }}" alt="" class="svg">1.26k</div>
                                    <div><img src = " {{ asset('backend/assets/img/svg/caret-down.svg ') }}" alt="" class="svg">1.2k</div>
                                 </div>
                              </div>
                           </div>
                           <!-- End Card -->
                              ...
                              <div class="card-body p-0">
                                 ...
                                 <div class="single-row border-bottom pt-3 pb-3">
                                    <div class="d-flex justify-content-between align-items-center">
                                       ...
                                       <div class="d-flex">
                                          <!-- Assign To -->
                                          <div class="assign_to">
                                             <img src = " {{ asset('backend/assets/img/svg/Info.svg ') }}" alt="" class="svg mr-2 mb-1">
                                          ...
                                          <!-- Drag Icon -->
                                          <img src = " {{ asset('backend/assets/img/svg/dragicon.svg ') }}" alt="" class="svg">
                                          <!-- End Drag Icon -->
                                 ...
                                 <div class="single-row border-bottom pt-3 pb-3">
                                    <div class="d-flex justify-content-between align-items-center">
                                       ...
                                       <div class="d-flex">
                                          <!-- Drag Icon -->
                                          <img src = " {{ asset('backend/assets/img/svg/dragicon.svg ') }}" alt="" class="svg mr-2">
                                          <!-- End Drag Icon -->
                                          <!-- Assign To -->
                                          <div class="assign_to">
                                             <img src = " {{ asset('backend/assets/img/svg/Info.svg ') }}" alt="" class="svg mb-1">
                                          </div>
                                          <!-- End Assign To -->
